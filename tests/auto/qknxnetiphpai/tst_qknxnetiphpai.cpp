...
void tst_QKnxNetIpHPAI::testSetFunctions()
{
    // SetAll on an unvalid HPAI
    {
        ...
        hpai.setHPAI(QKnxNetIpHPAI::HostProtocol::IpV4_Udp, QHostAddress::LocalHost, 3671);
        QCOMPARE(hpai.hostProtocol(), QKnxNetIpHPAI::HostProtocol::IpV4_Udp);
        QCOMPARE(hpai.address(), QHostAddress(QHostAddress::LocalHost));
        QCOMPARE(hpai.port(), quint16(3671));
    ...
    {
        QKnxNetIpHPAI hpai(QKnxNetIpHPAI::HostProtocol::IpV4_Udp, QHostAddress::LocalHost, 3333);
        QCOMPARE(hpai.hostProtocol(), QKnxNetIpHPAI::HostProtocol::IpV4_Udp);
        QCOMPARE(hpai.address(), QHostAddress(QHostAddress::LocalHost));
        ...
        hpai.setHPAI(QKnxNetIpHPAI::HostProtocol::IpV4_Tcp, QHostAddress::Broadcast, 3671);
        QCOMPARE(hpai.hostProtocol(), QKnxNetIpHPAI::HostProtocol::IpV4_Tcp);
    ...
    // Set individual on an unvalid HPAI
    {
        ...
        // Setting code only
        hpai.setHostProtocol(QKnxNetIpHPAI::HostProtocol::IpV4_Tcp);
        QCOMPARE(hpai.hostProtocol(), QKnxNetIpHPAI::HostProtocol::IpV4_Tcp);
        QCOMPARE(hpai.address(), QHostAddress(QHostAddress::Broadcast));
        QCOMPARE(hpai.port(), quint16(0));
        QCOMPARE(hpai.toString(), QString::fromLatin1("Total size { 0x08 }, Code { 0x02 }, "
    ...
    {
        QKnxNetIpHPAI hpai(QKnxNetIpHPAI::HostProtocol::IpV4_Udp,
...
void tst_QKnxNetIpHPAI::testDebugStream()
{
    ...
    qDebug() << QKnxNetIpHPAI(QKnxNetIpHPAI::HostProtocol::IpV4_Udp, QHostAddress::LocalHost, 3671);
...
void tst_QKnxNetIpHPAI::testDataStream()
{
    ...
    out << QKnxNetIpHPAI(QKnxNetIpHPAI::HostProtocol::IpV4_Udp, QHostAddress::LocalHost, 3671);
