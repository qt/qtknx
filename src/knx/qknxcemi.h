...
struct Q_KNX_EXPORT QKnxCemi final
{
    ...
    enum class ObjectType : quint16
    {
        // System Interface Object KnxNetIp (Profile A.5)
        Device = 0x0000,
        GroupAddressTable = 0x0001,
        GroupAssociationTable = 0x0002,
    ...
    enum class KnxNetIpParameterPID : quint8
    {
        OjectType = 0x01,
        ObjectName = 0x02,
    ...
    enum class GroupObjectAssociationTablePID : quint8
    {
        OjectType = 0x01,
        ObjectName = 0x02,
    ...
    enum class GroupAddressTablePID :quint8
    {
        OjectType = 0x01,
        ObjectName = 0x02,
        LoadStateControl = 0x05,
    ...
    enum class ApplicationProgramPID : quint8
    {
        OjectType = 0x01,
        ObjectName = 0x02,
        LoadStateControl = 0x05,
    ...
    enum class InterfaceProgramPID : quint8
    {
        OjectType = 0x01,
        LoadStateControl = 0x05,
        RunStateControl = 0x06,
    ...
    enum class GroupObjectTablePID : quint8
    {
        OjectType = 0x01,
        ObjectName = 0x02,
        LoadStateControl = 0x05,
        ...
        ErrorCode = 0x1c,
        ParameterReference = 0x33,
        ExtentedGroupObjectReference = 0x34
    };

    enum class DevicePID :quint8
    {
        OjectType = 0x01,
        ObjectName = 0x02,
        ServiceControl = 0x08,
...
Q_DECLARE_TYPEINFO(QKnxCemi::ApplicationProgramPID, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(QKnxCemi::DevicePID, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(QKnxCemi::GroupAddressTablePID, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(QKnxCemi::GroupObjectAssociationTablePID, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(QKnxCemi::GroupObjectTablePID, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(QKnxCemi::InterfaceProgramPID, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(QKnxCemi::KnxNetIpParameterPID, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(QKnxCemi::ObjectType, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(QKnxCemi::TransportControlField, Q_PRIMITIVE_TYPE);
