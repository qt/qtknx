...
/*!
    \class QKnxNetIpConfigDibView

    \inmodule QtKnx
    \brief The QKnxNetIpConfigDibView class provides the means to read the IP
    ...
    \note When using QKnxNetIpConfigDibView, care must be taken to ensure that
    ...
    \code
        ...
        QKnxNetIpConfigDibView view(dib);
        if (!view.isValid())
            return;
...
/*!
    \internal
    \fn QKnxNetIpConfigDibView::QKnxNetIpConfigDibView()
*/
...
/*!
    \internal
    \fn QKnxNetIpConfigDibView::QKnxNetIpConfigDibView(const QKnxNetIpDib &&)
*/
...
*/
QKnxNetIpConfigDibView::QKnxNetIpConfigDibView(const QKnxNetIpDib &dib)
    : m_dib(dib)
{}
...
*/
bool QKnxNetIpConfigDibView::isValid() const
{
...
*/
QKnxNetIp::DescriptionType QKnxNetIpConfigDibView::descriptionType() const
{
    if (isValid())
        return m_dib.code();
...
*/
QHostAddress QKnxNetIpConfigDibView::ipAddress() const
{
    if (isValid())
...
/*!
    ...
    returns an invalid \l QHostAddress.
*/
QHostAddress QKnxNetIpConfigDibView::subnetMask() const
{
    if (isValid())
...
/*!
    ...
    returns an invalid \l QHostAddress.
*/
QHostAddress QKnxNetIpConfigDibView::defaultGateway() const
{
    if (isValid())
...
/*!
    ...
    \l QKnxNetIp::Unknown.
*/
QKnxNetIp::Capabilities QKnxNetIpConfigDibView::capabilities() const
{
    if (isValid())
...
*/
QKnxNetIp::AssignmentMethods QKnxNetIpConfigDibView::assignmentMethods() const
{
    if (isValid())
...
/*!
    ...
    structure.
*/
QKnxNetIpConfigDibView::Builder QKnxNetIpConfigDibView::builder()
{
    return QKnxNetIpConfigDibView::Builder();
}


/*!
    \class QKnxNetIpConfigDibView::Builder

    \inmodule QtKnx
    \brief The QKnxNetIpConfigDibView::Builder class creates a KNXnet/IP
    ...
    \code
        ...
        auto dib = QKnxNetIpConfigDibView::builder()
...
*/
QKnxNetIpConfigDibView::Builder &
    QKnxNetIpConfigDibView::Builder::setIpAddress(const QHostAddress &ipAddress)
{
    if (!ipAddress.isNull())
...
*/
QKnxNetIpConfigDibView::Builder &
    QKnxNetIpConfigDibView::Builder::setSubnetMask(const QHostAddress &subnetMask)
{
...
*/
QKnxNetIpConfigDibView::Builder &
    QKnxNetIpConfigDibView::Builder::setDefaultGateway(const QHostAddress &gateway)
{
    if (!gateway.isNull())
        m_gateway = gateway;
    return *this;
...
*/
QKnxNetIpConfigDibView::Builder &
    QKnxNetIpConfigDibView::Builder::setCapabilities(QKnxNetIp::Capabilities capabilities)
{
...
*/
QKnxNetIpConfigDibView::Builder &
    QKnxNetIpConfigDibView::Builder::setAssignmentMethods(QKnxNetIp::AssignmentMethods methods)
{
...
/*!
    ...
    \sa isValid()
*/
QKnxNetIpDib QKnxNetIpConfigDibView::Builder::create() const
{
