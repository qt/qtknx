...
*/
QKnxTpdu QKnxTpduFactory::Multicast::createGroupValueResponseTpdu(const QByteArray &data)
{
...
/*!
    ...
    the given \a data.
*/
QKnxTpdu QKnxTpduFactory::Multicast::createGroupValueWriteTpdu(const QByteArray &data)
{
