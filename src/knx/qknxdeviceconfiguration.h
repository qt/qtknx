...
#ifndef QKNXDEVICECONFIGURATION_H
#define QKNXDEVICECONFIGURATION_H
...
class QKnxDeviceConfigurationPrivate;
class Q_KNX_EXPORT QKnxDeviceConfiguration
{
public:
    QKnxDeviceConfiguration();
    virtual ~QKnxDeviceConfiguration();

    virtual QKnx::MediumType mediumType() const;

    QKnxAddress individualAddress() const;
    void setIndividalAddress(const QKnxAddress &ia);
...
private:
    QSharedDataPointer<QKnxDeviceConfigurationPrivate> d_ptr;
};
