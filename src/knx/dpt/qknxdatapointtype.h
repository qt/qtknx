...
public:
    enum class Type : quint32
    {
        ...
        Dpt14_4ByteFloat = 1400000,
            DptValueAccelerationAngular, DptValueActivationEnergy, DptValueActivity, DptValueMol,
        ...
        Dpt19_DataTime = 1900000,
            DptDateTime = 1900001,
        Dpt20_1Byte = 2000000,
            DptPsuMode = 2000008, DptErrorClassSystem = 2000011, DptCommandMode = 2001000,
