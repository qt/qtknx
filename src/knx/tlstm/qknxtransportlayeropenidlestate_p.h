...
#ifndef QKNXTRANSPORTLAYEROPENIDLESTATE_P_H
#define QKNXTRANSPORTLAYEROPENIDLESTATE_P_H
...
class Q_KNX_EXPORT QKnxTransportLayerOpenIdleState : public QKnxTransportLayerState
{
public:
    using QKnxTransportLayerState::QKnxTransportLayerState;
    ~QKnxTransportLayerOpenIdleState() override = default;
