...
#ifndef QKNXTRANSPORTLAYEROPENWAITSTATE_P_H
#define QKNXTRANSPORTLAYEROPENWAITSTATE_P_H
...
class Q_KNX_EXPORT QKnxTransportLayerOpenWaitState : public QKnxTransportLayerState
{
public:
    using QKnxTransportLayerState::QKnxTransportLayerState;
    ~QKnxTransportLayerOpenWaitState() override = default;
    ...
    void event17() override final;
    void event18() override final;
