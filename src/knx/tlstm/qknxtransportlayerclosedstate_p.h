...
#ifndef QKNXTRANSPORTLAYERCLOSEDSTATE_H
#define QKNXTRANSPORTLAYERCLOSEDSTATE_H
...
class Q_KNX_EXPORT QKnxTransportLayerClosedState : public QKnxTransportLayerState
{
public:
    using QKnxTransportLayerState::QKnxTransportLayerState;
    ~QKnxTransportLayerClosedState() = default;

    void event00() override final;
